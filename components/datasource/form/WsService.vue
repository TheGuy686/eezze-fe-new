    ...
    <e-col>
        ...
        <a-tabs v-model="activeKey" style="padding-bottom: 30px;">
            ...
            <a-tab-pane key="connection-info" :tab="tr('connection-info')" e-scroll :style="`max-height: ${maxHeight}px;`">
                ...
                <DatasourceFormOConnectionOverrides :connection="connection" :hideDefaults="true" />
                    ...
                    <e-row clss="mt-2">
                        ...
                        <e-col :span="2" jc="fe">
                            ...
                            <EFormInput
                                ...
                                castTo="number"
                                :inlineOver="false"
                                :disabled="!entity?.metadata?.storeState"
                                :value="entity?.metadata?.storeStateInterval ?? 5000"
                                @input="setEntityProp({ key: 'metadata', value: {
                                        ...(entity?.metadata ?? {}),
