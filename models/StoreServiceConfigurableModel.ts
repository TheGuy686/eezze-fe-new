...
export default class StoreServiceConfigurableModel implements Interface {
    id: string;
    name: string;
    description: string;
    type: string;
    ...
    static create(obj: any) : StoreServiceConfigurableModel {
        return new StoreServiceConfigurableModel(
            obj['id'] || undefined,
            obj['name'] || undefined,
