import { tr, pascalCase } from '~/classes/globals';
...
export default class DatasourceModel implements IDatasource {
    id: string;
    key: string;
    type: string;
    name: string;
    ...
    constructor(
        ...
        if (typeof metadata == 'string') {
            try {
                ...
                console.log('Error parsing datasource model metadata');
                this.metadata = {};
            }
        }
    ...
    static create(obj: any) : DatasourceModel {
